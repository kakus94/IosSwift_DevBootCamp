...
struct StoryBrain { 
  ...
  func getChoise1() -> String { 
    getCurrentStory.choice1
  }
  
  func getChoise2() -> String { 
    getCurrentStory.choice2
  }
  
  var getCurrentStory: Story { 
    storys[currentStory]
  }
  
  mutating func choiseMade(_ name: String) {
    
    if getChoise1() == name { 
      currentStory = getCurrentStory.choice1Destination
    } else { 
      currentStory = getCurrentStory.choice2Destination
    }
